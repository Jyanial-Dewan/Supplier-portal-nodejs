...
const AllUsersThree = () => {
  ...
  const slicedAllUsers = sortedAllusers.slice(10,15)
  ...
  return (
    <section className={open? "pt-24 pl-[7rem] pr-4 duration-1000" : "pt-24 pl-[17.5rem] pr-4 duration-1000"}>
      ...
      <Pagination className='my-6'>
        <PaginationContent>
          <PaginationItem>
            <PaginationPrevious href="/allusers/2" />
          </PaginationItem>
          <PaginationItem>
          ...
          <PaginationItem>
            <PaginationLink href="/allusers/3" isActive>3</PaginationLink>
          </PaginationItem>
          <PaginationItem>
            <PaginationLink href="#">4</PaginationLink>
          </PaginationItem>
          <PaginationItem>
            <PaginationLink href="/allusers/4">5</PaginationLink>
          </PaginationItem>
          <PaginationItem>
            <PaginationEllipsis />
          </PaginationItem>
          <PaginationItem>
            <PaginationNext href="/allusers/4" />
          </PaginationItem>
        </PaginationContent>
      </Pagination>
